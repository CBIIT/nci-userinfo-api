...
const getBuilding = (obj) => {
    ...
    if (obj.BUILDINGNAME) {
        ...
        if (obj.NIHPHYSICALADDRESS && obj.NIHPHYSICALADDRESS.startsWith('9609 MEDICAL CENTER DR') && obj.NIHSITE && obj.NIHSITE === 'MD-RCK') {
            result = '9609';
        } else if (obj.NIHPHYSICALADDRESS && obj.NIHPHYSICALADDRESS.startsWith('9605 MEDICAL CENTER DR')) {
            result = '9605';
        } else if (obj.NIHPHYSICALADDRESS && obj.NIHPHYSICALADDRESS.startsWith('8560 PROGRESS DR')) {
            result = 'ATRF';
        }
    }
